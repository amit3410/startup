...
class CorpSocialmedia extends BaseModel
{
    /* The database table used by the model.
     *
     * @var string
     */
    protected $table = 'corp_socialmedia';
    ...
    public static function getData($user_kyc_id=''){
        $result=self::select('corp_socialmedia.*','mst_socialmedia.title as socialmedia')->join('mst_socialmedia','mst_socialmedia.id','=','corp_socialmedia.social_media')->where('user_kyc_id','=',$user_kyc_id)->get();
        return ($result?:false);
    }
