                    ...
                    <div class="card wizard-card" data-color="orange" id="wizardProfile">
                        ...
                        <form action="{{route('skills')}}" id="skillForm" method="post">
                            ...
                            <div class="tab-content Skills">
                                <div id="address">
                                    <h5 class="info-text">{{trans('master.skillsForm.heading')}}</h5>
                                    <div class="col-md-12">
                                        <div class="row   ">
                                            <div class="col-sm-3 ">
                                                <div class="form-groupp">
                                                    <label>{{trans('master.skillsForm.add_skills')}}<small class = "ismandtory">{{trans('master.skillsForm.sym')}}</small></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2 text-center">
                                                <div class="form-groupp">
                                                    <label>{{trans('master.skillsForm.beginner')}}</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-2 text-center">
                                                <div class="form-groupp">
                                                    <label>{{trans('master.skillsForm.intermediate')}}</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-2 text-center">
                                                <div class="form-groupp">
                                                    <label>{{trans('master.skillsForm.professional')}}</label>
                                                </div>
                                            </div>
                                        </div>
