...
class Compliancereportlog extends Authenticatable
{
     ...
     * @var string
     */
    protected $table = 'compliance_report_log';
 ...
 /**
     ...
     */
    public static function savecomplinceslog($arrComplince = [])
    {
    ...
    public static function getcomplinceslog($kycId)
    {
        /**
     ...
     */
     ...
     public static function updatecomplinceslog($kyc_id, $arrData = [])
    {
