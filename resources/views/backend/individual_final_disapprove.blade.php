...
'url' => route('individual_final_disapprove',['id'=>$userKycId,'profileId' => $profileId,'responceProfileId'=>$responceProfileId]),
'autocomplete' => 'off','class'=>'loginForm form form-cls'
))
!!}
<?php
if($userType == 1){
    $route=route("user_detail",['user_id' => $userData,'user_type' => $userType,'user_kyc_id'=>$userKycId,'tab' => 'tab06']);
  } else if($userType == 2){
...
<div class="row">
    ...
    <div class="col-sm-12 text-center">
        <h4 class="heading-brown mt-3">Do you want to Disapprove the User?</h4>
