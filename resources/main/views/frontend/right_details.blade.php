...
<section>
    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-md-9">
                <div class="panel-default mb-3 box-shadow-div">
                    <ul class="holder-history">
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-4 det box-shadow-div rightdetail4btn">
                                    <div class="holder-user-bg mb-3">
                                        ...
                                        <div class="card-header p-0">
                                            ...
                                            <div class="recommended-footer-right">
                                                ...
                                                @endif
                                                <ul class="pr-0" style="display: inline-flex;width: 100%;">
                                                    @if($rightDetail->ready_to_sale == 1)
                                    ...
                                    <div class=" Similar " style="overflow: hidden;width: 100%;">
                                        ...
                                        <div class="card-footer text-right rightdetailprice row m-0" style="overflow: hidden;width: 100%;padding: 0;">

                                            <div class="col-md-6 p-0 text-left">
                                                @if($rightDetail->user_id!= (int) Auth::user()->id)
                                                @if($rightDetail->ready_to_sale == 1)
                                                ...
                                                <a class="btn btn-x-sm btn-success   mb-1 rightpricesell" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$rightDetail->id])}}" data-height="600px" data-width="100%" data-placement="top">Buy<br> <span class="tooltip-2">| ${{ $rightDetail->non_exclusive_purchase_price}} <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                        <p>Non Exclusive</p>
                                                    </span> <span class="tooltip-2"> ${{ $rightDetail->exclusive_purchase_price}} <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                        <p>Exclusive</p>
                                                    </span> </a>
                                                ...
                                                <a class="btn btn-x-sm btn-success mb-1 rightpricesell" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$rightDetail->id])}}" data-height="600px" data-width="100%" data-placement="top">
                                                    Buy | ${{ $rightDetail->exclusive_purchase_price}} <span class="tooltip-2"> <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                        <p>Exclusive</p>
                                                    </span></a>
                                                @elseif($rightDetail->is_non_exclusive_purchase == 1)
                                                <a class="btn btn-x-sm btn-success mb-1 rightpricesell" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$rightDetail->id])}}" data-height="600px" data-width="100%" data-placement="top">
                                                    Buy | ${{ $rightDetail->non_exclusive_purchase_price}} <span class="tooltip-2"> <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                        <p>Non Exclusive</p>
                                                    </span></a>
                                                @endif
                                                @endif
                ...
                <div class="card box-shadow-div Similar-sec">
                    ...
                    <div class="card-body  pb-0 pt-0">
                        <div class="owl-carousel owl-theme">
                            ...
                            @php $similarRightCount = round($similarRightCount/5); @endphp
                            @for ($i = 1; $i <= $similarRightCount; $i++) <div class="list-slider">
                                ...
                                'Y-m-d H:i:s', 'd F Y H:i:s')}}</p>
                                    ...
                                    <div class="recommended-footer">
                                        ...
                                        <a class="btn btn-x-sm btn-success pull-left" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$similarRight->id])}}" data-height="600px" data-width="100%" data-placement="top">Buy<br> <span class="tooltip-2">| ${{ $similarRight->non_exclusive_purchase_price}}<i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <p>Non Exclusive</p>
                                            </span> <span class="tooltip-2"> ${{ $similarRight->exclusive_purchase_price}} <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <p>Exclusive</p>
                                            </span> </a>
                                        ...
                                        <a class="btn btn-x-sm btn-success pull-left" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$similarRight->id])}}" data-height="600px" data-width="100%" data-placement="top">
                                            Buy | ${{ $similarRight->exclusive_purchase_price}} <span class="tooltip-2"><i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <p>Exclusive</p>
                                            </span></a>
                                        @elseif($similarRight->is_non_exclusive_purchase == 1)
                                        <a class="btn btn-x-sm btn-success pull-left" data-toggle="modal" data-target="#rightpurchase" data-url=" {{route('buy_right_popup',['right_id'=>$similarRight->id])}}" data-height="600px" data-width="100%" data-placement="top">
                                            Buy | ${{ $similarRight->non_exclusive_purchase_price}} <span class="tooltip-2"><i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <p>Non Exclusive</p>
                                            </span></a>
                                        @endif
                                        @endif
                    ...
                    <div class="table-responsive table-custom">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @php $Sudoname = Helpers::getRightScoutSudoname($arrRightTransaction->userPublicKey); @endphp

                                <tr>
                                    <td>{{$arrRightTransaction->txnNumber}}</td>
                                    <td>{{date('m/d/Y', $arrRightTransaction->reportTime)}}</td>
                                    <td>{{$arrRightTransaction->address}}</td>
                                    <td>{{isset($Sudoname->first_name) ? $Sudoname->first_name :''}}</td>
                                </tr>
                                @endforeach
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date('m/d/Y', $arrRightScout->reportTime)}}</td>
                                    <td>{{$arrRightScout->address}}</td>
                                    <td>{{isset($arrSudoname->sudoname) ? $arrSudoname->sudoname :''}}</td>
                                </tr>
                                @endforeach
                ...
                <div class="term-condition">
                    ...
                    <div class="define">
                        ...
                        <ul>
                            ...
                            <li>12.<span> “Order”</span> means the Service Offering ordering document (including
