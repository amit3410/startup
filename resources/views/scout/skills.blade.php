            ...
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="wizard-container">
                    ...
                    <div class="card wizard-card" data-color="orange" id="wizardProfile">
                        ...
                        <form action="{{route('scout_skills')}}" id="skillForm" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="tab-content Skills">
                                                ...
                                                <div class="col-sm-12 small-select form-groupp">
                                                    <div class="row flex align-center">
                                                        <div class="text-field-select col-md-3">
                                                            ...
                                                            'class'=>'form-control clsRequired skill'))
                                                            !!}
                                                        </div>
                                ...
                                <div class="col-sm-6 text-right">
                                     <input type='button' onclick="window.location='{{route("scout_education_details",['user_id'=>Auth::user()->id])}}'" class='btn btn-previous btn-default btn-wd' name='previous' value='Previous' />
                                    <input type='submit' class='submitSkills btn btn-next btn-fill btn-warning btn-wd' name='next' value='Next' />                                </div>
