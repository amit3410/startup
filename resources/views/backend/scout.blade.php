       ...
       {!!
        ...
        <div class="col-md-4">
            ...
            {!!
                ...
                [''=>'Status', '1'=>'Active', '2'=>'Reject','0'=> 'Pending'],
                null,
                array('id' => 'is_active',
                'class'=>'form-control'))
            !!}
    ...
    <div class="table-border-top prtm-full-block">
            ...
            <div class="table-responsive">
               <div class="text-right"><input type="submit" name="delete_selected" id="delete_selected_user" class="btn-danger btn del-selected-cls delete-sel-jobseeker" value="Delete Selected"></div>
                <table class="data-table table-hover mrgn-all-none text-capitalize th-pad-all-sm td-pad-all-sm th-fw-light" id="scoutTable" style="width:100%;">
                    <thead>
...
<script>
var messages = {
    get_users: "{{ URL::route('get_scout') }}",
    delete_users: "{{ URL::route('delete_users') }}",
    data_not_found: "{{ trans('error_messages.data_not_found') }}",
    token: "{{ csrf_token() }}",    
};
</script>
<script src="{{ asset('backend/js/scout.js') }}" type="text/javascript"></script>
