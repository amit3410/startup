                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="university[0]" id="university0" class="is_required form-control clsRequired is_required" placeholder="University Name">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label>Course Name<small class = "ismandtory">*</small></label>
                                                            <div class="form-group">
                                                                <input value="" type="text" name="course[0]" id="course0" class=" is_required form-control clsRequired is_required">
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="wizard-footer">
                                ...
                                <div class="col-sm-6 text-left">
                                 ...
                                 <div class="col-sm-6 text-right">
                                     <input type='button' class='btn btn-previous btn-default btn-wd' onclick="window.location ='{{route("user_register_open")}}'" name='previous' value='Previous' />
