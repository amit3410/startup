                        ...
                        <form action="{{route('research_publication')}}" enctype="multipart/form-data" method="post" id="researchForm">
                            ...
                            <div class="tab-content">
                                <div id="reasearch" class="content_wz">
                                    <h5 class="info-text">{{trans('master.researchForm.heading')}}</h5>
                                    <div class="col-md-12">
                                            ...
                                            <div class="reasearch-edit clonedResearch add-sec" id="clonedResearch0">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>{{trans('master.researchForm.title')}}<small class = "ismandtory">*</small></label>
                                                        <input type="text" name="title[0]" id="title0" class="form-control clsRequired is_required" placeholder="{{trans('master.researchForm.title')}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>{{trans('master.researchForm.jor_mag')}}<small class = "ismandtory">{{trans('master.researchForm.sym')}}</small></label>
                                                ...
                                                <div class="col-sm-6 small-select form-group">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label>{{trans('master.researchForm.my_pub')}}<small class = "ismandtory">{{trans('master.researchForm.sym')}}</small></label>
                                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group ">
                                                        <div class="file-browse">
                                                            ...
                                                            <label class = "fileslabel" id ="picName0">{{trans('master.researchForm.att_file')}}</label>
<!--                                                            <input type="text" name="attachment[0]" id="attachment0" class="file-name" readonly="">-->
                                            ...
                                            <div class="reasearch-edit clonedResearch add-sec" id="clonedResearch{{$res}}">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>{{trans('master.researchForm.title')}}<small class = "ismandtory">{{trans('master.researchForm.sym')}}</small></label>
                                                        <input type="text" value = "{{(isset($research->title) && !empty($research->title)) ? $research->title : (old('title') ? old('title') : '')}}" name="title[{{$res}}]" id="title{{$res}}" class="form-control clsRequired is_required" placeholder="{{trans('master.researchForm.title')}}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group ">
                                                        <div class="file-browse">
                                                            ...
                                                            {{trans('master.researchForm.att_file')}}</label>
                            ...
                            <div class="col-sm-12"  style="padding: 0 8px;">
                                <div class="col-sm-6 text-left">
                                    <span style="@if(count($researchArr) < 5) visibility:visible @else visibility:hidden @endif" class="add-reasearch btn btn-primary mb-2"><span>{{trans('master.researchForm.sym1')}}</span>{{trans('master.researchForm.add_research')}}</span>

                                   
                                </div>
                                <div class="col-sm-6 text-right"> <input type='button' onclick="window.location='{{route("skills")}}'" class='btn btn-previous btn-default btn-wd' name='previous' value='{{trans('master.researchForm.pre')}}' />
                                    <input type='submit' class='btn btn-next btn-fill btn-warning btn-wd submitResearch' name='next' value='{{trans('master.researchForm.next')}}' />
                                </div>
                                <div class="clearfix"></div>
</div></div>
                        </form>
