                                            ...
                                            <div class="awards-edit clonedAwards add-sec" id="clonedAwards0">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title[0]" id="title0" class="form-control clsRequired is_required" placeholder="Title" autofocus="autofocus">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div data-error="hasError" class="textarea-field">
                                                            <textarea id="description0" name="description[0]" class="form-control clsRequired is_required" placeholder="Brief Description"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="wizard-footer">
                               <div class="col-sm-6 text-left">
                                ...
                                <div class="col-sm-6 text-right"> 
                                    <input type='button' onclick="window.location ='{{route("research_publication")}}'" class='btn btn-previous btn-default btn-wd' name='previous' value='Previous' />
