        ...
        oTable = $('#scoutTable').DataTable({
            ...
            ajax: {
                ...
                "error": function () {  // error handling
                    ...
                    $("#scoutTable").append('<tbody class="scoutTable-error"><tr><th colspan="3">' + messages.data_not_found + '</th></tr></tbody>');
                    $("#scoutTable_processing").css("display", "none");
                }
            },
            columns: [ 
                {data: 'checkbox'},
