...
<style>
    ...
    <body>
        ...
        <header>
            <img   src="{{ asset('frontend/outside/images/JD_logo.png') }}"  alt="Dexter Capital"  height="50"/>
             ...
             <table width="100%" border="0" style="border-collapse:collapse; background: #fff;">
                  <tbody>
                   ...
                   <tr>
                     ...
                     <tr>
                         <td>
                       <h4 style="font-size: 36px;background-color: #F7CA5A;color: #743939;font-weight: 500;text-align: center;padding: 10px;margin:0px;"> Compliance Report </h4>
                       <p style="color: #743939;font-size: 24px;font-weight:600;text-decoration: underline;text-align: center;padding: 0px 25px;margin:0px;">Individual Natural Person</p>
                      ...
                      <tr>
                        <td height="100px;" style="color:#743939;">Addressed To : {{$indi_jur_addressto}}</td>
                      </tr>
                      <tr>
                        <td height="120px;">&nbsp;</td>
                      </tr>
        ...
        <tbody>
               ...
               <tr>
                   <td height="">
                       ...
                       <!--<p style="margin:0px;padding: 0px 0px;color:#743939;font-weight: 300;">Doc Ref: JDX-COR-<?php echo date("M-Y");?>-Compliance Report-{{$userPersonalData->title.' '.ucfirst($userPersonalData->f_name)." ".$userPersonalData->m_name." ".$userPersonalData->l_name}}</p> -->
                       <p style="margin:0px;padding: 0px 0px;color:#743939;font-weight: 300;">Doc Ref: JDX-COR-<?php echo date("d-Y");?></p>
                       <p style="margin:0px 0 90px 0;padding: 0px 0px;color:#743939;font-weight: 300;">Dated: on <?php echo date("d M Y")?></p>
                       <p style="margin:70px 0px 0px;font-size:11px;padding: 0px;color:#743939;font-weight: 300;text-align: center;">11th Floor, Fujairah Tower, Fujairah, United Arab Emirates</p>
                       ...
                       <p style="margin:0px;font-size:11px;padding: 0px;color:#743939;font-weight: 300;text-align: center;"> </p><br/>
	...
	<table width="100%" class="table table-striped table-sm brown-th" style="font-family: 'Roboto', sans-serif;font-size:13px; ">
        <tbody>
            <!--Compliance Report For Corporate Entity-->
              <tr><td align="left" valign="top" height="400px">&nbsp;</td></tr>
               <tr>
                   <td>
              <table width="700px" border="0" style="border-collapse:collapse;  background: #fff;text-align: center;">
                  <tbody>
                     <tr>
                         <td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"  style=" font-family: 'Roboto', sans-serif;  font-size:13px; font-weight:300;">
        <tbody>
         <tr>
                 <td>
              <table width="700px" border="0" style="border-collapse:collapse; background: #fff; padding: 20px 0px 0px;">
                  <tbody>
                    <tr><td align="left" valign="top" height="0px"></td></tr>
                     <tr>
                         <td>
       ...
       <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"  style=" font-family: 'Roboto', sans-serif;  font-size:13px; font-weight:300;color:#743939">
        <tbody>
       ...
       <tr>
        ...
        <tr>
            <td align="center" style="">
                <table width="90%" border="1" style="border-collapse:collapse; background: #fff;" class="table-b">
                    <tbody>
                        <tr>
        ...
        <tr>
            <td>
                <table width="100%" border="0" style="border-collapse:collapse;background: #fff;padding: 20px 0px;">
                    ...
                    <thead>
                        <tr>
                            <th  style="font-size: 16px;" align="left">2. World Check Report</th>
                        </tr>
        ...
        <tr>
            <td>
                <table width="100%" border="0" style="border-collapse:collapse;background: #fff;padding: 20px 0px;">
                    ...
                    <thead>
                        <tr>
                            <th colspan="2"  align="left" style="font-size: 16px;">3. Internet General Investigation Report</th>
                        </tr>
                    </thead>
                    <tbody>
                                <tr>
                                ...
                                <tr >
                                    <td width="20%">Social Media Links URL:</td>
        ...
        <tr>
            <td>
                <table width="100%" border="0" style="border-collapse:collapse; background: #fff;padding: 20px 0px;">
                    ...
                    <thead>
                        <tr>
                            <th  width="100%" style="font-size: 16px;" align="left">4. References investigation</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="650px">{{isset($complianceReport->references_investigation) ? $complianceReport->references_investigation : ''}}</td>
                        </tr>
        ...
        <!-- General Investigataion  Report  End-->
                        <tr>
                            <td style="color:#743939;font-size: 16px;"> <b>5. Calculation of the final score according to the Onboarding risk assessment</b></td>
                            </tr>
                        <tr>
                            <td>
...
<tr>
                    <td>
                        <table width="90%" border="0" style="border-collapse:collapse; background: #fff;padding: 20px 0px;">
        ...
        <tr>
            <td>
                <table width="100%" border="0" style="border-collapse:collapse; background: #fff;padding: 20px 0px;">
                    ...
                    <thead>
                        <tr>
                            <th  align="left" height="20" style="font-size: 16px;">7. Conclusion and Recommendation</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
