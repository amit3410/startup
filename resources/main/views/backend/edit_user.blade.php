    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="prtm-block">
                ...
                !!}
                <input type="hidden" name="user_id" id='user_id' value="{{ isset($userData->id) ? $userData->id : null}}">
                    ...
                    <div class="form-group">
                        <label for="msg"> Occupation</label>   
                        {!!
                            Form::text('occupation',
                            isset($userData->occupation) ? $userData->occupation : '',
                            [
                            'class' => 'form-control',
                    ...
                    <div class="form-group">
                        ...
                        {!!
                            Form::text('about',
                            isset($userData->about) ? $userData->about : '',
                            [
                            'class' => 'form-control',
                            'placeholder' => 'About',
                            'id'=>'about'
                    ...
                    <div class="form-group">
                        <label for="Alternat Phone"> Alternat Phone</label>   
                        {!!
                            Form::text('alternate_phone',
                            isset($userData->alternate_phone) ? $userData->alternate_phone : '',
                            [
                            'class' => 'form-control',
                            'placeholder' => 'Alternat Pphone',
                            'id'=>'alternate_phone'
                            ])
                        !!}
                    </div>
