...
<body>
    ...
    ?>
        ...
        <header>
            <img   src="{{ asset('frontend/outside/images/JD_logo.png') }}"  alt="Dexter Capital" align="left" height="50"/>
        ...
        <tbody>
            <!--Compliance Report For Corporate Entity-->
              ...
              <table width="100%" border="0" style="border-collapse:collapse;  background: #fff;text-align: center;">
                  <tbody>
				<tr><td align="left" ><h3 style="margin:0; padding-bottom:0px; font-weight: 300;color:#743939;"><i> </i></h3></td></tr>

				   <tr><td align="left" valign="top" height="150px">&nbsp;</td></tr>
				  
                     <tr>
                         <td>
                       <h4 style="font-size: 36px;background-color: #F7CA5A;color: #743939;font-weight: 500;text-align: center;margin:0px 0 40px 0;"> Compliance Report</h4>
                       <p style="color: #743939;font-size: 24px;font-weight:600;text-decoration: underline;text-align: center;padding: 0px 25px;margin:0px;">{{isset($clientSubmitionData['corporationName'])?ucfirst($clientSubmitionData['corporationName']):''}}</p>
                       </td>
                      </tr>  
               ...
               <tr>
                   <td height="150px;" style="color: #743939;">Addressed to: {{$corp_jur_addressto}}</td>
               </tr>
               <tr>
                   <td height="170px;">&nbsp;</td>
               </tr>
               ...
               <tr>
                   <td height="">
                      ...
                      <p style="margin:0px;padding: 0px 0px;color:#743939;font-weight: 300;">Doc Ref: JDX-COR-<?php echo date("d-Y")?></p>
                       ...
                       <p style="margin:20px 0px 0px;font-size:11px;padding: 0px;color:#743939;font-weight: 300;text-align: center;">11th Floor, Fujairah Tower, Fujairah, United Arab Emirates</p>
  ...
  <tr>
    ...
    <table width="100%" class="table table-striped table-sm brown-th" style="font-family: 'Roboto', sans-serif;font-size:13px; color:#743939;">
       ...
       <table width="100%" class="table table-striped table-sm brown-th" style="font-family: 'Roboto', sans-serif;font-size:13px; color:#743939;">
                ...
                <tr>
                    <td>
                        <table width="640px" style="border-collapse:collapse; background: #fff;border:1px solid #743939; margin-top:15px;" class="table-b">
						<tbody>
                                <tr>
                        ...
                        <table width="100%" border="0" style="border-collapse:collapse; background: #fff;padding: 20px 0px;">
                         <thead>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td width="100%" colspan="2" style="padding:5px 20px;">{{Helpers::buildCategory(0, $category)}}</td>
                                    </tr>
                                            ...
                                            $FalseCount  = 0;
                                                    ...
                                                    <table width="100%" cellspacing="0">
                                                        <tr>
                                                           ...
                                                           <td width="70%" style="font-size:14px; text-align: left;"> <div style="margin-right:25px;display: inline;">Positive: {{$positivecount}}</div>
                ...
                <!-- General Investigataion  Report  End-->
                    ...
                    <td>
                        <table width="100%" border="0" style="border-collapse:collapse; background: #fff;padding:20px 0px;">
                            ...
                            <tbody>
				<tr>
                                    <td height="30" align="left" style="font-size: 16px;"  colspan="2"><b>6. Calculation of the final score according to the Onboarding risk assessment</b></td>
                                </tr>
                                ...
                                <tr>
                                                <td colspan="2" bgcolor="#fff">
                                                   ...
                                                   // echo "<pre>";
                                                    ...
                                                    ?>
                                                    <table class="table table-striped table-sm" width="640px" border="1" style="border-collapse:collapse; background: #fff;">
                                                    <tr>
                                                       <td colspan="2">
                                                        <table class="table table-striped table-sm table-b" width="640px" border="0" style="border-collapse:collapse; background: #fff;">
														<tbody>
                                                            <tr>
                                                            <td width="70%"><strong>Final Score</strong></td>
                                                        <td width="30%" style="border-left: 1px solid #dee2e6;"><center><strong>{{ number_format($averageScore,2) }}</strong></center></td>
                                                        </tr>
														</tbody>
                                                        </table>
                                                        </td>
                        ...
                        <table width="640px" border="0" style="border-collapse:collapse; background: #fff;padding:20px 0px">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td > {{ isset($complianceReport['conclusion_recommendation']) ? $complianceReport['conclusion_recommendation'] : ''}}</td>
                                </tr>
                                 <tr>
                                     <td width="100%" >&nbsp;</td>
                                </tr>
