     ...
     <div class="form-section">
       ...
       <div class="row marB10">
           <div class="col-md-12">
            ...
            <form id="otherDocsIndvForm" enctype="multipart/form-data" class="needs-validation form" novalidate method="post">
            @csrf
...
var globlvar={
    "save_doc_url":"{{ route('upload_other_document',['user_kyc_id' => $userKycId, 'corp_user_id' => $corpUserId, 'is_by_company' => $isBycompany]) }}",
};
