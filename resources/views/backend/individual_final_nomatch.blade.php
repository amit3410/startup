...
'url' => route('individual_final_nomatch',['id'=>$userKycId,'profileId' => $profileId,'responceProfileId'=>$responceProfileId]),
...
<div class="row">
    ...
    <div class="col-sm-12 text-center">
        <h4 class="heading-brown">No Match Found Against Search?</h4>
             <input  name="nomatch" type="hidden" value="1">
            <input class="btn btn-save btn-sm perwcapi" name="saveyes" type="submit" value="Yes">
            <input class="btn btn-default btn-sm perwcapi" name="save" type="button" value="Close" onclick="callclose()">
