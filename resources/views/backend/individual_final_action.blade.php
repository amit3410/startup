...
'url' => route('individual_final_approve',['id'=>$userKycId,'profileId' => $profileId,'responceProfileId'=>$responceProfileId]),
...
<?php
if($userType == 1){
    $route=route("user_detail",['user_id' => $userData,'user_type' => $userType,'user_kyc_id'=>$userKycId]);
  } else if($userType == 2){
    $route=route("corp_user_detail",['user_id' => $userData,'user_type' => $userType,'user_kyc_id'=>$userKycId]);
  }
?>
...
<div class="row">
    ...
    <div class="col-sm-12 text-center">
        ...
        <h4 class="heading-brown mt-3">Do you want to Approve the User?</h4>
            <input class="btn btn-save btn-sm perwcapi" name="saveyes" type="submit" value="Yes">
            <input class="btn btn-save btn-sm" name="save" type="button" value="No" onclick="callclose()">
    </div>
