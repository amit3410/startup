            ...
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="wizard-container">
                    ...
                    <div class="card wizard-card" data-color="orange" id="wizardProfile">
                        ...
                        <form action="{{route('scout_research_publication')}}" enctype="multipart/form-data" method="post" id="researchForm">
                                            ...
                                            <div class="reasearch-edit clonedResearch add-sec" id="clonedResearch0">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title[0]" id="title0" class=" is_required form-control clsRequired" placeholder="Title">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Journal/Magazine<small class = "ismandtory">*</small></label>
                                                        <input type="text" name="journal_magazine[0]" id="journal_magazine0" class=" is_required form-control clsRequired" placeholder="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 small-select form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="text-field-select col-md-6">
                                                            ...
                                                            'class'=>' is_required form-control select2Cls clsRequired'))
                                                            !!}
                                                        </div>
...
<!--                                                            <input type="text" name="attachment[0]" id="attachment0" class="file-name" readonly="">-->
                                            ...
                                            <div class="reasearch-edit clonedResearch add-sec" id="clonedResearch{{$res}}">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Title<small class = "ismandtory">*</small></label>
                                                        <input type="text" value = "{{(isset($research->title) && !empty($research->title)) ? $research->title : (old('title') ? old('title') : '')}}" name="title[{{$res}}]" id="title{{$res}}" class=" is_required form-control clsRequired" placeholder="Title">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Journal/Magazine<small class = "ismandtory">*</small></label>
                                                        <input type="text" value = "{{(isset($research->journal_magazine) && !empty($research->journal_magazine)) ? $research->journal_magazine : (old('journal_magazine') ? old('journal_magazine') : '')}}" name="journal_magazine[{{$res}}]" id="journal_magazine0" class=" is_required form-control clsRequired" placeholder="">
                                                    </div>
                                                </div>
                              ...
                              <div class="wizard-footer">
                                ...
                                <div class="col-sm-6 text-right">
                                      <input type='button' onclick="window.location='{{route("scout_skills",['userId'=>Auth::user()->id])}}'" class='btn btn-previous btn-default btn-wd' name='previous' value='Previous' />
